    ...
    <div onClick={onClick} css={mainContCss}>
      <Flex direction="column" justify="center" align="" css={cont}>
        <Flex direction="column" justify="center" align="flex-start">
          <Text typography="t6" textAlign="left" className="nameCss">
            {user.name}
          </Text>
          <Text typography="t8" textAlign="left">
            {user.email}
          </Text>
        </Flex>
      </Flex>
      <div onClick={onIconClick} css={iconCss}>
        {isSelected ? <CheckmarkCircle24Regular /> : <Circle24Regular />}
      </div>
    </div>
  )
}
