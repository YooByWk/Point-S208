...
const WebTeamDeleteSelected = ({
  ...
  const selectedTeamAlbum = useRecoilValue(selectedTeamAlbumIdState)
    ...
    try {
      const deletePromises = selectedCards.map(cardId =>
        mutate({
          ...
          teamAlbumId: selectedTeamAlbum.teamAlbumId,
          cardId: cardId,
        }),
      )
...
export default WebTeamDeleteSelected
